...
├── account.html                # 个人中心 —— 资料（联系方式自助修改）/ 偏好设置（主题外观 + 通知；通知走网页推送，App 壳内不显示，由壳的本地通知承担）/ 日历订阅 / 安装到桌面（仅 iOS 与 PC 显示，安卓 / 鸿蒙已有原生 App）/ 修改密码 / 强制刷新 / 关于软件（版本号 / 检查更新）/ 退出登录
